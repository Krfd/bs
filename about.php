...
<body>
    ...
    <div class="container-fluid py-5 hero-about">
        <div class="container mt-5 pt-5">
            ...
            <div class="w-50 text-white mt-5 pt-5">
                <h4 class="fw-bold">Who we are?</h4>
                <p class="fw-light">
                    De Exito Catering Services and Event Decorators offers a
    ...
    <div class="py-5">
        <div class="py-3 py-md-5 px-0 px-md-5 d-block d-md-flex justify-content-center gap-5">
            <div class="py-5">
                <img src="./assets/img/cater2.jpg" alt="Cater" class="rounded-1 shadow w-auto" />
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5 my-5 d-block d-md-flex justify-content-between align-items-center">
            <div>
                <img src="" alt="" />
            </div>
            <div>
    ...
    <div class="container-fluid py-5">
        <div class="container my-5 py-5">
            <h2 class="fw-bold text-center text-uppercase">Reviews</h2>
