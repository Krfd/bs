...
<body>
    ...
    <div class="container-fluid hero-home py-5">
        <div class="container text-center py-5 my-5">
            ...
            <button class="btn d-block mx-auto border-3 border-light text-light rounded-0">
                Book Now
            </button>
        </div>
    </div>
    ...
    <div class="container-fluid bg-secondary py-5">
        <div class="container d-flex justify-content-evenly align-items-center">
            <div class="box text-center">
                ...
                <br />
                <small>Liked by many customers</small>
            </div>
            <div class="box text-center">
                <i class="fa-solid fa-bowl-food icon"></i>
                <br />
                <small>Delicious dishes</small>
            </div>
            <div class="box text-center">
                <i class="fa-solid fa-peso-sign icon"></i>
                <br />
                <small>Affordable price</small>
            </div>
            <div class="box text-center">
