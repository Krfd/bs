<footer class="footer py-5">
    <div class="container d-block d-md-flex justify-content-between my-5 p-5">
        <div class="left-content d-flex gap-3">
            <img src="./assets/logo.jpg" alt="Logo" style="width: 100px; height: 100px">
            <div class="details">
                <h4 class="fw-bold">Catering Services <br /> &amp; Event Decorators</h2>
                    <i class="fa-solid fa-location-dot"></i> <span>Iloilo, City</span>
                    <br>
        ...
        <div class="center-content text-center">
            <h5 class="fw-bold text-uppercase">Hours</h5>
            <div>
            ...
            <br>
            <div>
                <h6 class="text-uppercase">Saturay - Sunday</h6>
                <span>10:00 am - 10:00 pm</span>
            </div>
        </div>
        <div class="right-content">
            <h5 class="fw-bold text-uppercase">Follow</h5>
            <ul class="list-unstyled d-flex justify-content-between gap-3">
                <li><a href="facebook.com" class="text-white"><i class="fa-brands fa-facebook"></i></a></li>
                <li><a href="instagram.com" class="text-white"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="twitter.com" class="text-white"><i class="fa-brands fa-twitter"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
        ...
        <hr class="text-white">
        <div>
            <ul class="list-unstyled d-block d-md-flex justify-content-evenly align-items-center text-uppercase">
